...
export function soundLens(p, appState) {
    let spectrum = [];
    ...
    const ADJUSTED_PI = Math.PI + 0.005 // helps visual rendering, preventing tiny gaps in circles
    ...
    p.draw = function() {
        ...
        // THIS IS AS FAR AS I GOT IN THE RE-FORMAT FOR ONLINE
