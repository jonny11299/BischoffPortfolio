...
import Dec2Scene from '../scenes/dec2Scene.js';
...
export function animationsDec2(p, appState) {
    let name = "animationsDec2"
    let resizeHandler;
    let frameCount = 0;
    ...
    p.setup = function(){
        ...
        curScene = new Dec2Scene('entrance_interactive', p, palette, appState);
        curScene.onEnter();
